...
class VirtualSD:
    def __init__(self, config):
        ...
        self.gcode.register_command(
                "MKS_LOAD_FILE_POSITION",
                self.cmd_MKS_LOAD_FILE_POSITION)
        self.gcode.register_command(
    ...
    # do_resume was only added so the Artillery code can use this function and
    # skip the resume part
    def cmd_SDCARD_PRINT_FILE(self, gcmd, do_resume=True):
        if self.work_timer is not None:
    ...
    def cmd_SDCARD_SELECT_FILE(self, gcmd):
        self.cmd_SDCARD_PRINT_FILE(gcmd, False)
